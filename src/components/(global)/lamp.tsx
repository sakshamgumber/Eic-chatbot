...
export function LampComponent({className}:{className:string}) {
  return (
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[800px] flex-col items-center justify-center overflow-hidden bg-neutral-950 w-screen rounded-md z-0',
        className
      )}
    >
